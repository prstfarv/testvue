      ...
      import { customSafelistExtractor, generateSafelist } from "C:/me/files/testvue/node_modules/@nuxt/ui/dist/runtime/utils/colors";
      ...
      export default {
        ...
        content: {
          files: [
            "C:/me/files/testvue/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "C:/me/files/testvue/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
